...
const ProductDetailScreen = ({ route, navigation }) => {
  ...
  /* useEffect(() => {
    axios.get(`https://be6dfa3ce27c.ngrok-free.app/api/produits/${product.reference}/prix-moyen`)
  ...
  try {
    await axios.put(` https://9a1123bcdc46.ngrok-free.app/api/produits/${product.reference}`, {
      designation,
